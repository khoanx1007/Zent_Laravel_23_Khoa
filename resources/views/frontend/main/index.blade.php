		...
		<div class="jumbotron jumbotron-fluid mb-3 pt-0 pb-0 bg-lightblue position-relative">
			...
			<div class="pl-4 pr-0 h-100 tofront">
				...
				<div class="row justify-content-between">
					...
					<div class="col-md-6 d-none d-md-block pr-0" style="background-size:cover;background-image:url(frontend/assets/img/demo/home.jpg);">	</div>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="row">
			...
			<div class="col-lg-6">
				<div class="flex-md-row mb-4 box-shadow h-xl-300">
					...
					<div class="mb-3 d-flex align-items-center">
						<img height="80" src="frontend/assets/img/demo/blog5.jpg">
						<div class="pl-3">
							<h2 class="mb-2 h6 font-weight-bold">
					...
					<div class="mb-3 d-flex align-items-center">
						<img height="80" src="frontend/assets/img/demo/blog6.jpg">
						<div class="pl-3">
							<h2 class="mb-2 h6 font-weight-bold">
