...
<head>
  ...
  <title>LARAVEL 23 | Tạo mới User</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
            <div class="card card-dark">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="{{route('backend.users2.store') }}" method="post" role="form" enctype="multipart/form-data" autocomplete="off">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Nhập ngày...">
                  </div>
                  <div class="form-group">
